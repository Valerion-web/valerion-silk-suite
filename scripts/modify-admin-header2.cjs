...
const re = /<div className=\"flex flex-wrap items-end gap-4\">[\s\S]*?<p className=\"mt-4 max-w-2xl text-base leading-7 text-\#\[0-9A-Fa-f\]{6}\">\{section.subtitle\}<\/p>/m;
