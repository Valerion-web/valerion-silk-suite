...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crafted for modern gentlemen who value timeless elegance, confidence and refined sophistication." },
      { name: "author", content: "House of Valerion" },
      { property: "og:title", content: "House of Valerion — Luxury Menswear" },
      { property: "og:description", content: "Crafted for modern gentlemen who value timeless elegance, confidence and refined sophistication." },
